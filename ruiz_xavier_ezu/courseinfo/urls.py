"""ruiz_xavier_ezu URL Configuration
...
from courseinfo.views import (
    SectionList, CourseList, SemesterList, StudentList,
    RegistrationList, InstructorList, InstructorDetail, SectionDetail, SemesterDetail, CourseDetail, StudentDetail,
    RegistrationDetail
)
